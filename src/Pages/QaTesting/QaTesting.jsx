...
function QaTesting() {
  ...
  return (
    <>
        ...
        <div className="container mx-auto max-w-[1140px] px-6 lg:px-0">
          ...
          <div className="relative z-10 max-w-3xl text-white text-center sm:text-left">
            ...
            <p className="text-md sm:text-lg mb-4">
              At SaturnX Digital Solution Company, we provide top-notch QA and software testing services, ensuring your software is bug-free and performs optimally. Our team specializes in both manual and automated testing, delivering comprehensive solutions to enhance functionality, improve reliability, and provide a seamless user experience.
            </p>
            <Button
      ...
      <div className='py-16 px-6 lg:px-0 bg-gray-200 relative w-full font-poppins'>
        <div className='container mx-auto max-w-[1140px]'>
          <div className="my-2 w-full flex flex-col items-center justify-center text-center">
            <h4 className="text-2xl lg:text-4xl mb-4 font-bold max-w-4xl">
              Why Choose SaturnX Digital Solutions for Your QA and Testing?
            </h4>
            <p className="text-lg  text-gray-700 mb-12">
              Discover how SaturnX Digital Solutions provides exceptional QA and testing services to ensure your software meets the highest standards of quality, reliability, and performance.
            </p>
          </div>

          <div className='grid grid-cols-1 lg:grid-cols-2 gap-12'>
            <div>
              <h4 className="text-3xl font-semibold text-primary mb-6">Comprehensive QA and Testing Services</h4>
              <p className="text-lg text-gray-700 mb-6">
                At SaturnX Digital Solutions, we offer a comprehensive range of QA and testing services that ensure the flawless functionality of your software. Our expert team of QA engineers works relentlessly to identify bugs, improve performance, and enhance the user experience, giving your customers the best version of your product.
              </p>
              <ul className="list-disc pl-6 text-lg text-gray-700 mb-6">
                <li>Manual and automated testing for web and mobile applications</li>
                <li>Regression, performance, and load testing</li>
                <li>Security testing to prevent vulnerabilities</li>
              </ul>
              
              <div className="mb-6">
                <h4 className="text-xl font-semibold text-primary mb-3">4. Faster Time-to-Market with Continuous Testing</h4>
                <p className="text-lg text-gray-700">
                  With our continuous testing model, we help reduce time-to-market, allowing you to launch your software faster without compromising on quality. By integrating testing into your development cycle, we ensure immediate feedback and faster bug fixes.
                </p>
              </div>

              <div className="mb-6">
                <h4 className="text-xl font-semibold text-primary mb-3">5. Cost-Effective and Scalable Solutions</h4>
                <p className="text-lg text-gray-700">
                  Our QA and testing services are not only effective but also cost-efficient. We offer scalable solutions that grow with your project, making it easier to allocate resources where they are most needed.
                </p>
              </div>
            </div>

            <div>
              <h4 className="text-3xl font-semibold text-primary mb-6">Why Our QA and Testing Services Stand Out</h4>
              <p className="text-lg text-gray-700 mb-6">
                When it comes to QA and testing, SaturnX Digital Solutions stands out due to our unique approach, advanced tools, and dedicated team. Here’s why we are the preferred choice for businesses around the globe:
              </p>

              <div className="mb-6">
                <h4 className="text-xl font-semibold text-primary mb-3">1. Experienced and Certified QA Professionals</h4>
                <p className="text-lg text-gray-700">
                  Our QA team consists of experienced, certified, and skilled professionals who understand the latest trends in testing. We follow best practices and leverage the most up-to-date testing tools and methodologies.
                </p>
              </div>

              <div className="mb-6">
                <h4 className="text-xl font-semibold text-primary mb-3">2. Advanced Testing Tools and Technologies</h4>
                <p className="text-lg text-gray-700">
                  We use state-of-the-art testing tools and technologies, including Selenium, Appium, LoadRunner, JMeter, and more, to ensure thorough testing and high-quality results.
                </p>
              </div>

              <div className="mb-6">
                <h4 className="text-xl font-semibold text-primary mb-3">3. Tailored Testing Strategies</h4>
                <p className="text-lg text-gray-700">
                  We understand that each project is unique. That’s why we tailor our QA strategies to fit your specific needs. Whether you're building a web application, mobile app, or enterprise software, we design customized testing approaches to ensure maximum quality.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className='w-full relative py-16 px-6 lg:px-0 font-poppins'>
        <div className='container mx-auto lg:px-28'>
          <div className='my-2 w-full flex flex-col items-center justify-center text-center'>
            <h4 className="text-2xl lg:text-4xl mb-4 font-bold max-w-4xl">Our Streamlined Development Process for Quality Assurance</h4>
            <p className='max-w-3xl'>
              SaturnX Digital Solution Company delivers scalable QA and software testing services tailored to meet your business needs. We ensure consistent quality, fast delivery, and cost-effective solutions that help businesses succeed in a competitive digital world.
            </p>
          </div>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-4 mt-20'>
            <div className='relative flex flex-col items-center justify-center'>
              {testingAccordion.map((accordion, index) => {
                return (
                  <div key={index} className='cursor-pointer w-full p-4 rounded-lg   hover:bg-gray-200 mb-4 transition-all'>
                    <div onClick={() => handleClick(index)} className="flex items-center justify-between w-full">
                      <div className="flex items-center space-x-2">
                        <p className='mr-2'>{accordion.svg}</p>
                        <h4 className='text-lg font-bold'>{accordion.title}</h4>
                      </div>
                    ...
                    {/* Accordion content that shows if it's clicked */}
                    {accordionIndex === index && (
                      <p className='mt-4 text-gray-700'>{accordion.content}</p>
                    )}
                  </div>
                );
              })}
