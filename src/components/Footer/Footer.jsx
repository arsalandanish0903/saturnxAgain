...
const Footer = () => {
    return (
        <footer class="font-sans tracking-wide bg-gray-200 border-t-2 border-gray-300 px-10 pt-12 pb-6">
            ...
            <li>
              <a href='javascript:void(0)' class='hover:text-gray-800 text-gray-600 text-sm'>UIPath</a>
                ...
                <div class="flex flex-wrap max-md:flex-col gap-4">
                    ...
                    <p class='text-gray-600 text-sm md:ml-auto'>© Saturnx. All rights reserved.</p>
                </div>
            </div>
        </footer>
    );
